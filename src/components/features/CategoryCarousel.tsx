            ...
            <div className="snap-start shrink-0 basis-[240px] sm:basis-[260px] md:basis-[280px] lg:basis-[270px]">
              <div className="h-[360px]">
                <Link href="/categorias" className="block h-full group">
                  <div className="relative h-full rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-primary to-emerald-700 flex items-center justify-center">
                    <div className="text-center p-6">
                      <ArrowRight className="h-12 w-12 text-white mx-auto mb-4 group-hover:translate-x-2 transition-transform" />
